...
class CommentForm extends components {
  ...
  render()
  {
    return(
      <React.Fragment>
        <Button onClick={this.toggleModal}><span className="fa fa-pencil fa-lg">Submit Comment</span></Button>
        <Modal isOpen={this.state.isModalOpen} toggle={this.toggleModal}>
          <ModalHeader toggle={this.toggleModal}>Submit Comment</ModalHeader>
          <ModalBody>
            <LocalForm onClick={(values) => {this.submitHandel(values)}}>
...
class CommentForm extends Component {
  ...
  render() { 
      return ( 
          <React.Fragment>
          <Button className="bg-white text-dark" onClick={this.handleToggle}><span className="fa fa-pencil fa-lg"></span>{' '}Submit Comment</Button>
